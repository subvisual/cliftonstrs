defmodule Talents.Accounts do
  ...
  alias Talents.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Talents.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Talents.Accounts.User.password_changeset/3` for a list of supported options.
