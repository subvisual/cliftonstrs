...
talents = %{
  ...
  2 => %{
    ...
    text_contrast_one: "Activator: There is no substitute for action. / Intellection: There is no substitute for thinking. ",
    text_contrast_two: "Activator: Do it until you get it right. / Deliberative: Do it when you get it right."
  },
  3 => %{
    name: "Adaptability",
    theme: "R",
    ...
    text_contrast_one: "Adaptability: I like it when every day is different. / Discipline: I like it when every day is the same. ",
    text_contrast_two: "Adaptability: Responds to changes in an environment. / Arranger: Initiates or manages changes in an environment."
  },
  4 => %{
    name: "Analytical",
    theme: "T",
    ...
    text_contrast_two: "Analytical: Truth is objective and must be measured. / Connectedness: Truth is spiritual and may be invisible."
  },
  5 => %{
    name: "Arranger",
    theme: "E",
    ...
    text_contrast_two: "Arranger: A juggler who momentarily touches all the balls. / Responsibility: A football player who tenaciously holds on to the ball."
  },
  6 => %{
    name: "Belief",
    theme: "E",
    ...
    text_contrast_one: "Belief: There is only one right way, so I will not be distracted by other paths. / Strategic: There are many possible ways, so I must consider them all. ",
    text_contrast_two: "Belief: Seeing comes with believing. / Analytical: Believing comes with seeing."
  },
  7 => %{
    name: "Command",
    theme: "I",
    ...
    text_contrast_one: "Command: Creates clarity through polarization. / Harmony: Creates consensus through harmonization. ",
    text_contrast_two: "Command: People are drawn to you because they know what you think. / Empathy: People are drawn to you because they know what they feel."
  },
  8 => %{
    name: "Communication",
    theme: "I",
    ...
    text_contrast_one: "Communication: I think and learn best when I can talk with others. / Intellection: I think and learn best when I can be alone and quiet. ",
    text_contrast_two: "Communication: Telling a story helps others understand my message. / Context: The re-telling of history helps others remember the past."
  },
  9 => %{
    name: "Competition",
    theme: "I",
    ...
    text_contrast_one: "Competition: When I watch others perform, I get better. / Significance: When others watch me perform, I get better. ",
    text_contrast_two: "Competition: The scoreboard measures my progress and validates victory. / Analytical: Data quantify experience and validate theories."
  },
  10 => %{
    name: "Connectedness",
    theme: "R",
    ...
    i_need: "to be part of something bigger than myself: a family, a team, an organization, a global community",
    ...
    text_contrast_two: "Connectedness: Aware of the inherent, invisible unity that already exists. / Includer: Aware of the invisible social exclusion that often exists."
  },
  11 => %{
    name: "Consistency",
    theme: "E",
    ...
    text_contrast_one: "Consistency: Treating people similarly promotes fairness. / Individualization: Treating people differently promotes fairness. ",
    text_contrast_two: "Consistency: I like merry-go-rounds. / Adaptability: I like roller coasters."
  },
  12 => %{
    name: "Context",
    theme: "T",
    ...
    text_contrast_one: "Context: I naturally remember and revere what has been. / Futuristic: I naturally anticipate and imagine what could or should be. ",
    text_contrast_two: "Context: I can proceed when I understand the history. / Focus: I can proceed when the goal is clear."
  },
  13 => %{
    name: "Deliberative",
    theme: "E",
    ...
    metaphor_image: "An ounce of prevention is worth a pound of cure; a jury must deliberate before there is a verdict",
    barrier_label: "hesitant — it’s the early bird that gets the worm",
    text_contrast_one: "Deliberative: Like a brake, I tend to slow things down. / Activator: Like an accelerator, I tend to speed things up. ",
  ...
  14 => %{
    ...
    text_contrast_one: "Developer: I notice and promote growth in others. / Maximizer: I notice and promote excellence. ",
    text_contrast_two: "Developer: Interested in getting people done. / Achiever: Interested in getting work done."
  },
  15 => %{
    name: "Discipline",
    theme: "E",
    ...
    text_contrast_one: "Discipline: I meet deadlines because it makes me feel good. / Responsibility: I meet deadlines because it makes others respect me. ",
    text_contrast_two: "Discipline: Can’t see the forest for the trees. / Connectedness: Can’t see the trees for the forest."
  },
  16 => %{
    name: "Empathy",
    theme: "R",
    ...
    text_contrast_one: "Empathy: I usually can tell how someone feels. / Individualization: I usually can tell who someone is. ",
    text_contrast_two: "Empathy: Intuition helps me decide what to do. / Analytical: Data help me decide what to do."
  },
  17 => %{
    name: "Focus",
    theme: "E",
    ...
    text_contrast_two: "Focus: I have a goal I plan to reach. / Discipline: I have a plan to reach my goal."
  },
  18 => %{
    name: "Futuristic",
    theme: "T",
    ...
    text_contrast_one: "Futuristic: I’m so preoccupied with tomorrow that I’m not ready for today. / Adaptability: I’m so occupied with today that I’m not ready for tomorrow. ",
    text_contrast_two: "Futuristic: I can see a better world. / Strategic: I can see the route that will take us to a better world."
  },
  19 => %{
    name: "Harmony",
    theme: "R",
    ...
    text_contrast_one: "Harmony: Let’s do what works best. / Belief: I want to do what matters most. ",
    text_contrast_two: "Harmony: Being interdependent, I willingly defer to experts. / Self-Assurance: Being independent, I confidently rely on my own expertise."
  },
  20 => %{
    name: "Ideation",
    theme: "T",
    ...
    text_contrast_one: "Ideation: I open the windows of my mind to increase the possibility of discovery. / Focus: I close the windows of my mind to decrease the possibility of distraction. ",
    text_contrast_two: "Ideation: A blue-sky approach to the creation of innovation is the best way to get a competitive advantage. / Harmony: The down-to-earth approach of efficient collaboration is the best way to get a competitive advantage."
  },
  21 => %{
    name: "Includer",
    theme: "R",
    ...
    text_contrast_one: "Includer: I work for the acceptance of those on the outside. / Harmony: I work for the agreement of those on the inside. ",
    text_contrast_two: "Includer: Be indiscriminately accepting of all who are on the bus. / Maximizer: Be discriminatingly selective about who gets on the bus."
  },
  22 => %{
    ...
    text_contrast_one: "Individualization: I know who you are. / Relator: I want to know you, and I want you to know me. ",
    text_contrast_two: "Individualization: Starts with a person and finds the right job for him. / Arranger: Starts with a job that needs to get done and finds the right person for it."
  },
  23 => %{
    name: "Input",
    theme: "T",
    ...
    text_contrast_one: "Input: I love to collect things that are potentially helpful. / Learner: I love the process of learning. ",
    text_contrast_two: "Input: I help people by sharing tangible tools I have acquired. / Ideation: I help people by sharing creative ideas I have conceived."
  },
  24 => %{
    name: "Intellection",
    theme: "T",
    ...
    text_contrast_one: "Intellection: An inquiring approach to growth and learning. / Input: An acquiring approach to growth and learning. ",
    text_contrast_two: "Intellection: Thinks about concepts that need to be understood. / Restorative: Thinks about problems that need to be solved."
  },
  25 => %{
    name: "Learner",
    theme: "T",
    ...
    text_contrast_one: "Learner: My interests guide my intentions. / Focus: My intentions guide my interests. ",
    text_contrast_two: "Learner: I am always interested in learning something new. / Woo: I am always interested in meeting someone new."
  },
  26 => %{
    name: "Maximizer",
    theme: "I",
    ...
    text_contrast_one: "Maximizer: I aspire to meet or exceed a standard of excellence. / Competition: I aspire to be number one. ",
    text_contrast_two: "Maximizer: I want to build something great. / Restorative: I want to fix something broken."
  },
  27 => %{
    name: "Positivity",
    theme: "R",
    ...
    text_contrast_two: "Positivity: Praise can’t be overdone, so I am generous with it. / Deliberative: Praise can be overdone, so I use it sparingly."
  },
  28 => %{
    name: "Relator",
    theme: "R",
    ...
    text_contrast_one: "Relator: Socially transparent, I invite my friends in. / Includer: Socially inclusive, I invite outsiders in. ",
    text_contrast_two: "Relator: I want to get to know more about the people I already know. / Woo: I want to get to know more people."
  },
  29 => %{
    name: "Responsibility",
    theme: "E",
    ...
    text_contrast_one: "Responsibility: If you can’t do it right, don’t do it. / Activator: Doing something is always better than not doing anything. ",
    text_contrast_two: "Responsibility: I feel intense guilt when I fail to do something right. / Significance: I feel intense regret when I miss an opportunity to succeed."
  },
  30 => %{
    name: "Restorative",
    theme: "E",
    ...
    text_contrast_two: "Restorative: I intentionally invade problem areas to restore the original state. / Positivity: I intentionally evade problem areas to maintain my emotional state."
  },
  31 => %{
    name: "Self-Assurance",
    theme: "I",
    ...
    text_contrast_one: "Self-Assurance: Anticipates risk so that it can be engaged and overcome. / Deliberative: Anticipates risk so that it can be avoided and minimized. ",
  ...
  32 => %{
    ...
    i_am: "interested in being seen as significant so that I can accomplish something significant",
    ...
    metaphor_image: "Natural performer who is comfortable with the visibility of center stage/bright lights",
    barrier_label: "attention hound, showboat",
    text_contrast_one: "Significance: I want to be admired so I must do something admirable. / Woo: I want to win others over so I must be winsome. ",
    text_contrast_two: "Significance: To be seen and heard is my desire. / Deliberative: To watch and listen is my desire."
  },
  33 => %{
    name: "Strategic",
    theme: "T",
    ...
    text_contrast_one: "Strategic: Natural evaluator of possibilities. / Analytical: Natural evaluator of realities. ",
    text_contrast_two: "Strategic: Considers alternative routes. / Focus: Concentrates on a singular destination."
  },
  34 => %{
    name: "Woo",
    theme: "I",
    ...
    text_contrast_one: "Woo: Can build a broad social network. / Relator: Can build a deep social network. ",
